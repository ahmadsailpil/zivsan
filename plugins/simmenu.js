 ...
 *Powered By @${'6283160327945'.split('@')[0]}*` 
  ...
  let who = m.mentionedJid && m.mentionedJid[0] ? m.mentionedJid[0] : m.fromMe ? conn.user.jid : m.sender
    ...
    status: 1,
    surface : 1,
    message: `𝘼𝙎𝙀𝙋𝘽𝙊𝙏𝙕 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`, 
    orderTitle: `▮Menu ▸`,
    ...
    const fkgif = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 "text":`𝘼𝙎𝙀𝙋𝘽𝙊𝙏𝙕 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
                 "title": `𝘼𝙎𝙀𝙋𝘽𝙊𝙏𝙕 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
 ...
 *Powered By @${'6283160327945'.split('@')[0]}*`
 ...
       const sections = [
                              {
                                "rows": [{
                                         "title": "📊 › Status ",
                                         "description": "Status カ 𝘼𝙎𝙀𝙋𝘽𝙊𝙏𝙕-MD",
                                         "rowId": ".botstat"
                                    }, {
                                         "title": "⚡› Speed ",
                                         "description": "Menampilkan Kecepatan Respon カ 𝘼𝙎𝙀𝙋𝘽𝙊𝙏𝙕-MD",
                                         "rowId": ".ping"
                                    }, {
                                         "title": "🗒️› Info ",
                                         "description": "Menampilkan Info カ 𝘼𝙎𝙀𝙋𝘽𝙊𝙏𝙕-MD",
                                         "rowId": ".info"
                                    }, {
                                         "title": "🎐 › Developer Bot ",
                  ...
                  "rowId": ".? owner"
                                ...
                                "description": "Last Update Terakhir Di 𝘼𝙎𝙀𝙋𝘽𝙊𝙏𝙕-MD",
                                "rowId": ".notes"                  
                }],                
                                "title": "▮Last Update 」"
                                }, {
 ...
           ] 
    const listMessage = {
      ...
      footer: '© 𝘼𝙎𝙀𝙋𝘽𝙊𝙏𝙕-MD By 𝐑𝐈𝐃𝐇𝐎 𝐆𝐀𝐍𝐙',
      title: judul,
 ...
         externalAdReply: { 
             title: '𝘼𝙎𝙀𝙋𝘽𝙊𝙏𝙕 Testing Project By 𝐑𝐈𝐃𝐇𝐎 𝐆𝐀𝐍𝐙', 
